...
export class GdmLiveAudio extends HTMLElement {
    ...
    private initializeGeminiClient() {
        ...
        if (apiKey) {
            ...
            console.error(UI_TEXT.errorApiKeyMissing + " (GdmLiveAudio)");
            this.setState(LiveAudioState.ERROR, UI_TEXT.errorApiKeyMissing, LiveAudioState.API_KEY_MISSING, UI_TEXT.errorApiKeyMissing);
        }
    }
